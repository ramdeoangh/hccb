...
|
*/
$config['rest_ip_whitelist'] = '::1,191.96.159.68';
...
|
| e.g. $config['allowed_origins'] = ['https://ci.y4dlearning.in', 'https://hccb.y4dlearning.in']
|
*/
 
$config['allowed_cors_origins'] = ['https://ci.y4dlearning.in', 'https://hccb.y4dlearning.in'];
